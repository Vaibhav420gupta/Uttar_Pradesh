...
<head>
  ...
  <title>Tour Uttar Pradesh </title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="index.php">Tour Uttar Pradesh</a>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/990.jpg')">
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          <ul class="list-inline text-center">
            <li class="list-inline-item">
              <a href="https://twitter.com/Vaibhav32756208">
            ...
            <li class="list-inline-item">
              <a href="https://m.facebook.com/profile.php?id=100006038146838">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
